...
$user = 'u53886'; // Заменить на ваш логин uXXXXX
$pass = '3324601'; // Заменить на пароль, такой же, как от SSH
$db = new PDO('mysql:host=localhost;dbname=u53886', $user, $pass,
...
try {
  ...
  $stmt->execute();
  $dbh = new PDO('mysql:host=localhost;dbname=u53886', $user, $pass);
